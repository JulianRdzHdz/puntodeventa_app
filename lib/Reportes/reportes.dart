            ...
            return Card(
              child: ListTile(
                ...
                trailing: Text(
                  ...
                  style: TextStyle(fontSize: 16, color: Colors.black), // Set the text color to black
                ),
                onTap: () {
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                ...venta.items.map((item) => Text('${item.cantidad} x ${item.nombre} - \$${item.precio}')),
              ],
            ),
          ),
          actions: [
                      ...
                      pw.Page(
                        build: (pw.Context context) => pw.Column(
                          children: [
                            pw.Header(
                              level: 0,
                              child: pw.Text('Ticket de Venta', textAlign: pw.TextAlign.center),
                            ),
                            ...
                            pw.Table.fromTextArray(
                              ...
                              data: <List<String>>[
                                ...
                                ...venta.items.map(
                                  (item) => [item.cantidad.toString(), item.nombre, '\$${item.precio}'],
                                ),
                              ],
                            ),
                            pw.Paragraph(text: 'Total: \$${venta.total.toStringAsFixed(2)}'),
...
// Las clases Venta e ItemVenta y la lista de ventas van aquí...
            ...
            Venta({required this.fecha, required this.hora, required this.total, required this.items});
            }
            ...
            ItemVenta({required this.nombre, required this.precio, required this.cantidad});
            }
